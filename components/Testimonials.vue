...
<template>
  <section class="w-screen bg-white dark:bg-slate-600">
    <h2
      class="text-3xl font-semibold text-center mb-5 pt-6 dark:text-slate-100"
    >
      What Our <span class="text-violet-500">Users</span> Say
    </h2>
    <p class="text-center text-base sm:text-lg text-slate-500 max-w-md mx-auto">Hear genuine stories from our satisfied users about their exceptional esperiences with us</p>
    <div class="max-w-[1100px] mx-auto shadow-2xl rounded-lg p-4">
      ...
      >
        <p
          class="text-base sm:text-lg text-left mt-1 text-slate-200 before:content-['\201C'] before:font-serif before:absolute before:top-0 before:left-0 before:text-9xl before:text-slate-200 before:opacity-25 before:transform before:translate-x-2 before:translate-y-2 after:content-['\201D'] after:font-serif after:absolute after:-bottom-0 after:right-0 after:text-9xl after:text-slate-200 after:opacity-25 after:transform after:-translate-x-2 after:translate-y-8"
        >
      ...
      <p
        class="italic text-sm sm:text-lg text-right mt-2 mb-6 pr-3 text-slate-500 dark:text-slate-400"
      >
        &#8212;Adekunle E, Student.
      </p>
      <blockquote
      ...
      >
        <p
          class="text-base sm:text-lg text-left mt-2 text-slate-200 before:content-['\201C'] before:font-serif before:absolute before:top-0 before:left-0 before:text-9xl before:text-slate-200 before:opacity-25 before:transform before:translate-x-2 before:translate-y-2 after:content-['\201D'] after:font-serif after:absolute after:-bottom-0 after:right-0 after:text-9xl after:text-slate-200 after:opacity-25 after:transform after:-translate-x-2 after:translate-y-8"
        >
      ...
      <p
        class="italic text-base sm:text-xl text-right mt-2 pr-3 mb-6 text-slate-500 dark:text-slate-400"
      >
        &#8212;Mrs Eno E, Parent.
      </p>
      <blockquote
      ...
      <p
        class="italic text-sm sm:text-lg text-right mt-2 pr-3 mb-6 text-slate-500 dark:text-slate-400"
      >
