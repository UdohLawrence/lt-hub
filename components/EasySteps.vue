...
<template>
    <section class="w-screen bg-white dark:bg-slate-600">
        <h2 class="text-3xl font-semibold text-center mb-5 py-5 dark:text-slate-100">
            Get Professional Home Tutors in <br />3 <span class="text-violet-700 dark:text-violet-500">Easy</span> Steps
        </h2>
        <div class="max-w-[1100px] flex flex-col sm:grid sm:grid-cols-3 gap-3 mx-auto p-5">
            <div class="p-6 shadow-lg relative rounded-md">
